...
- Untested domains: scientific/technical prose (would likely stress the currency problem harder — findings get superseded constantly) and narrative fiction (unclear whether `Attribution` even applies cleanly to a third-person narrator).
